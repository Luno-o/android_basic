...
class TransportDialogFragment : DialogFragment(R.layout.fragment_transport_dialog) {
    ...
    private val transportClickListener:TransportClickListener?
        get() = when(parentFragment){
            is ListFragmentLinearLayout->{parentFragment.let { it as ListFragmentLinearLayout }}
            is ListFragmentGridLayout->{parentFragment.let { it as ListFragmentGridLayout }}
            is ListFragmentStaggeredLayout->{parentFragment.let { it as ListFragmentStaggeredLayout }}
            else-> null
        }
