...
val name = "Messages"
        ...
        val channel = NotificationChannel(MESSAGE_CHANNEL_ID,name,priority).apply { description = channelDescription
    ...
    private fun createInfoChannel(context: Context){
        ...
        val channel = NotificationChannel(INFO_CHANNEL_ID,name,priority).apply { description = channelDescription }
        NotificationManagerCompat.from(context).createNotificationChannel(channel)
    }
}