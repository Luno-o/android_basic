...
):AbstractWarrior(maxHealth,dodgeChance,accuracy,weapon, currentHealth
){
    override var isKilled: Boolean = currentHealth<=0
    companion object{
        fun createSoldier():OrdinarySoldier{
            return OrdinarySoldier(maxHealth = 1000,dodgeChance = 10,accuracy = 50,weapon = Weapons.pistol, currentHealth = 1000)
        }
    }
