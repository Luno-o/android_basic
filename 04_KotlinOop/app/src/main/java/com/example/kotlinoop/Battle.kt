...
class Battle (var team1: Team, var team2: Team){
    ...
    var endBattle:Boolean = getBattleState() == BattleState.Team1Win(team1,team2) || getBattleState() == BattleState.Team2Win(team1,team2)
    ...
    fun nextBattleTurn() {
        ...
        team1.warriorsList.forEach { if (it.isKilled){team1.warriorsList.remove(it)}else {}}
        team2.warriorsList.forEach { if (it.isKilled){team1.warriorsList.remove(it)}else{} }
    }
}